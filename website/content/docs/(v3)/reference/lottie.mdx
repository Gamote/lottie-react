---
title: Lottie and LottieLight
description: The two components, and every prop of their own.
---
...
| `lottieRef` | `Ref<LottieHandle>` | The commands, handed back. |
...
Identical surface, smaller engine, `svg` only; the types refuse the other renderers.
The light engine contains no `eval`.
